...
import { CategoryScale, Chart as ChartJS, ChartOptions, CoreScaleOptions, Legend, LinearScale, LineElement, PointElement, Scale, Title, Tooltip, TooltipItem } from 'chart.js';
...
export const WebPerformanceTrends: React.FC<WebPerformanceTrendsProps> = ({
  ...
  return <div className={stylex.props(styles.s9ca97d).className || ''}>
