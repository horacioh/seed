...
interface MobileTextTypeDialogProps {
  isOpen: boolean
  onClose: () => void
  currentValue: string
...
const textTypeOptions = [
  {
    label: 'Paragraph',
    value: 'paragraph',
    icon: <Type className={stylex.props(styles.sca3de969).className || ''} />,
  },
  {
    label: 'Heading',
    value: 'heading',
    icon: <HeadingIcon className={stylex.props(styles.sca3de969).className || ''} />,
  },
  {
    label: 'Code Block',
    value: 'code-block',
    icon: <Code className={stylex.props(styles.sca3de969).className || ''} />,
  },
]
