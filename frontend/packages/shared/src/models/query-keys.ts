...
export const queryKeys = {
  ...
  VAULT_PASSWORD_STATUS: 'VAULT_PASSWORD_STATUS',
  VAULT_NOTIFICATION_SERVER: 'VAULT_NOTIFICATION_SERVER',
  ...
  DOCUMENT_COLLABORATORS: 'DOCUMENT_COLLABORATORS', //, id.uid: string, ...id.path
  ...
  NOTIFICATION_STATE: 'NOTIFICATION_STATE', // notifyServiceHost, accountUid
