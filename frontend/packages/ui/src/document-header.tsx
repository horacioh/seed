    ...
    >
      <div className="flex flex-col gap-2 md:gap-4">
        ...
        {breadcrumbs && breadcrumbs.length > 0 ? (
          <Breadcrumbs breadcrumbs={breadcrumbs} className="max-md:hidden" />
        ) : null}
...
export function Breadcrumbs({breadcrumbs, className}: {breadcrumbs: BreadcrumbEntry[]; className?: string}) {
  ...
  return (
    <nav aria-label="Breadcrumb" className={cn('text-muted-foreground flex flex-1 items-center', className)}>
