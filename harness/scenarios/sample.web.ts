...
export const scenario: Scenario = {
  ...
  steps: [
    ...
    { action: "type", locator: { testId: "password" }, value: "demo-password", description: "Enter the demo password" },
    ...
    { action: "assert", kind: "text", locator: { testId: "todo-count" }, expected: "2 items · 0 completed", description: "Two todos are shown" },
    { action: "click", locator: { testId: "todo-check-0" }, description: "Complete the first todo" },
    { action: "assert", kind: "text", locator: { testId: "todo-count" }, expected: "2 items · 1 completed", description: "Completed count updates" },
    { action: "assert", kind: "attr", locator: { testId: "todo-0" }, expected: "class=todo completed", description: "Completed todo has completed styling" },
  ],
};
